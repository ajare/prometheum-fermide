...
namespace core
{
	...
	public:
		...
		LadderTransit(uint32_t index, uint32_t layerIndex, uint32_t cellX, uint32_t cellY, uint32_t levelsHigh, std::vector<TransitStop> const& stops, bool extensible, bool startExtended);
