...
void handleWorldInteraction(std::shared_ptr<core::Building> building, std::shared_ptr<const core::Graph> graph, std::shared_ptr<core::Agent> pathingAgent, MouseButtonStatus const& mouseStatus);
