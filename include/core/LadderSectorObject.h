...
namespace core
{
	...
	public:
		...
		LadderSectorObject(uint32_t cellX, uint32_t cellY, uint32_t decksHigh, std::shared_ptr<const Sector> sector, bool extensible, bool startExtended, uint32_t* vertexIdentifer = nullptr);
